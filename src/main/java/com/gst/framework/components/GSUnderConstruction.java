...
// @Route(value = "underconstruction", layout = GSMainLayout.class)
public class GSUnderConstruction extends VDFlexBoxLayout {
  
  private static final long serialVersionUID = -7408951668255086151L;
  
  public GSUnderConstruction() {
    showMessage();
  }
  
  private void showMessage() {
    Div div = new Div();
    VDLabel message = new VDLabel("功能建置中!");
