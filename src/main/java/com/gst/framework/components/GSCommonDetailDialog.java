...
public class GSCommonDetailDialog extends Dialog implements VDConfirmDialog.ConfirmHandler {
  ...
  private static final long serialVersionUID = -3618232096005594671L;
  ...
  public GSCommonDetailDialog(GSDetailRepresentation component) {
  ...
  private void createHeader() {
    ...
    if (titleIcon.getColor() == null || titleIcon.getColor().trim().isEmpty()) {
  ...
  private void createFooter() {
    ...
    if (mode == ViewMode.View) {
      ...
      GSPMCManufactureOrderActivityReviewDetail reviewForm =
        ((GSPMCManufactureOrderActivityReviewDetail) component);
