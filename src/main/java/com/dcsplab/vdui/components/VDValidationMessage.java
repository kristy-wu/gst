...
public class VDValidationMessage extends HorizontalLayout implements HasText {
  private static final long serialVersionUID = -3293616808095847048L;
  
  private final Span span = new Span();
  
  public VDValidationMessage() {
    setVisible(false);
