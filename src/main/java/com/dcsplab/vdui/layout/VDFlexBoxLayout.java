...
import com.dcsplab.vdui.layout.size.Size;
import com.dcsplab.vdui.util.css.*;
...
public class VDFlexBoxLayout extends FlexLayout {
  ...
  private static final long serialVersionUID = -6156752158304408869L;
  private final ArrayList<Size> spacings;
  
  public VDFlexBoxLayout(Component... components) {
    super(components);
