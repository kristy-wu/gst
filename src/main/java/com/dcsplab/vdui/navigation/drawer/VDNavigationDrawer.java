...
public class VDNavigationDrawer extends Div implements AfterNavigationObserver {
  
  private static final long serialVersionUID = 5173543884457086432L;
  ...
  private VDNavigationMenu menu;
  
  public VDNavigationDrawer() {
    ...
    // getStyle().set("background-image", "url('./images/bg_sky.jpg')");
  }
  ...
  private void initHeader() {
    mainContent.add(new BrandExpression("GST-MES"));
  }
  ...
  public VDNavigationMenu getMenu() {
    return menu;
  }
